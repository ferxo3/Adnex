    ...
    <>
      ...
      <main>
        ...
        <section className="relative z-10 bg-white pb-[170px] dark:bg-dark-300 max-md:pb-25">
          <div className="absolute -top-[200px] left-1/2 -z-10 h-[550px] w-full -translate-x-1/2  bg-[url('/images/hero-gradient.svg')] bg-cover bg-center bg-no-repeat opacity-70 md:hidden"></div>
