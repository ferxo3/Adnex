    ...
    <>
      ...
      <main>
        ...
        <section className="relative pb-150">
          <div className="absolute -top-[300px] left-1/2 -z-10 h-[550px] w-full -translate-x-1/2  bg-[url('/images/hero-gradient.svg')] bg-cover bg-center bg-no-repeat opacity-70 md:hidden"></div>
