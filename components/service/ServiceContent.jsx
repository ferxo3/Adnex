...
const ServiceContent = ({ data }) => {
  ...
  return (
    <>
      {modal ? (
        <div className="modal-bg bg-transparent">
      ...
      <section className="relative pb-150 pt-[200px] max-md:overflow-hidden max-md:pb-20 max-md:pt-25">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid auto-rows-max grid-cols-12 gap-y-15 md:gap-8 lg:gap-16">
            <div className="self-start rounded-medium bg-white/50 p-2.5 shadow-nav dark:bg-dark-200 max-md:static max-md:col-span-full max-md:hidden md:sticky md:top-20 md:col-span-6 lg:col-span-4">
            ...
            <div className="relative max-md:col-span-full md:col-span-6 lg:col-span-8">
              <div className="singlePage relative  max-md:mt-20">
                ...
                <div className="rounded-medium bg-white/50 p-2.5 shadow-nav dark:bg-dark-200">
                  <Image
                ...
                <div className="relative rounded-medium bg-white/50 p-2.5 shadow-nav dark:bg-dark-200">
                  <Image
