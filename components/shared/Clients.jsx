    ...
    <section className={cn('client', className)}>
      <div className="container overflow-hidden max-lg:!px-0">
        <div className=" px-10px mx-auto max-w-[550px] text-center max-lg:px-2.5">
          {sectionTitle && <h2 className="mb-10">Confía en las soluciones de vanguardia con Adnex</h2>}
          {sectionDetails && <p className="text-light mb-15">Las Herramientas que Impulsan tu Éxito</p>}
        </div>
