  ...
  return (
    <section className="relative bg-white pb-150 dark:bg-dark-300 sm:overflow-hidden">
      ...
      <div className="container">
        {sectionDetails && (
          <div className="mb-12">
            <p className="section-tagline max-lg:text-center">Servicios</p>
            <div className="block max-lg:text-center lg:flex">
             ...
             <br />  a tu Negocio
              ...
              Desde inteligencia artificial hasta SEO y desarrollo web, optimizamos cada aspecto de tu presencia digital.
              </p>
            </div>
          </div>
        )}
