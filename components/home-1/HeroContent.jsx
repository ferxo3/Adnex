import Image from 'next/image'; // Asegúrate de que esta línea esté al principio
    ...
    <FadeUpAnimation className="relative z-10 grid grid-cols-12 items-center max-lg:gap-y-10">
      <div className="col-span-12 md:col-span-6">
        <p className="mb-8 font-medium uppercase max-lg:mb-4">
          Estrategias de Marketing y Diseño Web Innovadoras
        </p>
        <h1 className="mb-12 max-md:mb-8">
          ...
          y diseño web con Adnex.
        </h1>
        <p className="mb-12 max-w-[590px] max-md:mb-8">
          En Adnex, hacemos que tu marca brille. Ofrecemos soluciones de
          marketing digital, diseño web y automatización para impulsar el
          crecimiento de tu negocio de manera efectiva.
        </p>
        <form>
      ...
      <div className="col-span-12 md:col-span-6">
        <div className="relative min-h-[530px] w-full max-md:min-h-[400px] lg:ml-15 bg-animated">
          ...
          <div className="lg:!not-sr-only-bottom-[45px] absolute !-bottom-0 !-right-5 max-lg:w-[196px] max-md:!-bottom-5 max-md:!-right-5 lg:right-0 xl:right-[30px]">
            <img src="/images/hero/hero-chart.svg" alt="hero Image" className="inline-block dark:hidden" />
            <img src="/images/hero/hero-chart-dark.svg" alt="hero Image" className="hidden dark:inline-block" />
          </div>
        </div>
      </div>
    </FadeUpAnimation>
