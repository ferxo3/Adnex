    ...
    <section className="relative -mt-24 overflow-hidden bg-gray pb-150 pt-[300px] dark:-mt-24 dark:bg-dark max-md:-mt-60 max-md:pb-20 max-md:pt-[320px] dark:max-md:-mt-60">
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            <p className="section-tagline">Integración de Datos Avanzada
            </p>
            <h2 className="mb-8 max-lg:mb-4">La innovación y el análisis de datos son claves para el éxito </h2>
            <p className="mb-11 max-lg:mb-5">
            En Adnex, entendemos que la integración de datos es el corazón de las decisiones empresariales inteligentes. 
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium dark:text-white">Automatización Inteligente de Procesos</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-7 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium dark:text-white">Integración en Tiempo Real</span>
              </li>
              <li className="flex items-center gap-x-2 ">
                <span className=" shadow-icon item-center relative flex h-7 w-7 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium dark:text-white">Análisis Predictivo Personalizado</span>
              </li>
            </ul>
